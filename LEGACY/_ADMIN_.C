...
void admin_bike_register(int *page, unsigned long *ID, LINKLIST *LIST)
{
    ...
    // 列出数据
    admin_list_info(LIST, id_list, fp_EBIKE_INFO_read, "register", mode, LIST_PAGEDOWN, LIST_CLEAR_CONTINUE, "\0", "\0");
...
void admin_bike_license(int *page, unsigned long *id, LINKLIST *LIST)
{
    ...
    admin_list_info(LIST, id_list, fp_EBIKE_LICENSE_read, "license", mode, LIST_PAGEDOWN, LIST_CLEAR_CONTINUE, "\0", "\0"); // 列出数据
...
void admin_bike_broken(int *page, unsigned long *id, LINKLIST *LIST)
{
    ...
    admin_list_info(LIST, id_list, fp_EBIKE_INFO_read, "broken", mode, LIST_PAGEDOWN, LIST_CLEAR_CONTINUE, "\0", "\0"); // 列出数据
...
void admin_bike_anual(int *page, unsigned long *id, LINKLIST *LIST)
{
    ...
    admin_list_info(LIST, id_list, fp_EBIKE_INFO_read, "anual", mode, LIST_PAGEDOWN, LIST_CLEAR_CONTINUE, "\0", "\0"); // 列出数据
...
void admin_bike_violation(int *page, unsigned long *id, LINKLIST *LIST)
{
    ...
    admin_list_info(LIST, id_list, fp_EBIKE_INFO_read, "violation", mode, LIST_PAGEDOWN, LIST_CLEAR_CONTINUE, "\0", "\0"); // 列出数据
